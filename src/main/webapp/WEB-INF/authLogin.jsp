                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                            <h3 class="text-white font-weight-bolder text-center mt-2 mb-0" href="/mainpage">Cozy-Stays</h3>
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="/login" method="post" modelAttribute="LoginDto">
                            ...
                            <div class="text-center">
                                <a href="/forgotpsw/" class="text-body text-decoration-none">Have you forgotten your password?</a>
                            </div> 
                            <div class="text-center">
                                <button id="btnLogin" type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">Sign In</button>
                            </div>
                           <div class="align-content-center text-center">
                               <a class="mt-4 text-sm text-center" href="/register/authRegister">Don't you have an account yet?</a>
                           </div>
                        </form>
                    </div>
                </div>
