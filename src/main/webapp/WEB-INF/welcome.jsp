...
<head>
    ...
    <!-- Font Awesome Icons -->
    <script src="https://kit.fontawesome.com/ad8cacfefd.js" crossorigin="anonymous"></script>
    <!-- Material Icons -->
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8 text-center mx-auto my-auto">
                    <h1 class=" text-white" >Cozy-Stays</h1>
                    <p class="lead mb-4 text-white opacity-8">Your next place is here</p>
                    <a class="btn bg-gradient-primary text-white border-radius-lg" href="${pageContext.request.contextPath}/publication/chosen-publications"> I want to find a rent </a>
                    <span>ㅤㅤ</span>
                    <%
                        if (session.getAttribute("authentication") != "true"){
                    %>
                    <a class="btn bg-gradient-primary text-white border-radius-lg" href="${pageContext.request.contextPath}/login">I would like to announce a rental fee</a>
                    <%
                        }
                    %>
                    <%
                        if (session.getAttribute("authentication") == "true"){
                    %>
                    <a class="btn bg-gradient-primary text-white border-radius-lg" href="${pageContext.request.contextPath}/publication/creation">I would like to announce a rental fee</a>
                    <%
                        }
                    %>
...
<div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6">
    ...
    <section class="py-7">
        <div class="container">
            <h3 class="text-center mb-5">It's simple</h3>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <div class="card card-body border-0 shadow-lg">
                        ...
                        <p class="mt-3 mb-0">Find your favorite rent, the best location, and the best price.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <div class="card card-body border-0 shadow-lg">
                        ...
                        <p class="mt-3 mb-0">Contact the rental owner and arrange transaction details.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <div class="card card-body border-0 shadow-lg">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="icon-text">
                                <h5 class="mb-0">Enjoy</h5>
                            </div>
                        </div>
                        <p class="mt-3 mb-0">Enjoy your new home and the best rental experience.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4 mb-5">
        <div class="col">
            <div class="card h-100" style="--bs-btn-hover-bg:100">
                ...
                <div class="card-body">
                    <h5 class="card-title">Rent around Faku</h5>
                    <div class="row">
...
<%--                    <h2 class="card-text"> $ 10.000 <i class="far fa-heart text-primary"></i></h2>--%>
                    <p class="card-text">
                        The department provides all services, including the Internet, water and electricity, with incredible views of the city.
                    </p>
                </div>
            </div>
        </div>
